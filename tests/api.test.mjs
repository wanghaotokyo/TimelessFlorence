...
try{
 ...
 await test('missing provider configuration never produces fake content',async()=>{const r=await fetch(origin+'/api/jobs',{method:'POST',headers,body:JSON.stringify({id:randomUUID(),kind:'resolve',query:'维纳斯'})});assert.equal(r.status,503);});
